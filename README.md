...
Concretely, I have mainly advanced the Software part. To create an accurate model, I based myself on the article and the code of Mr [Keith Bloemer](https://github.com/GuitarML) and the paper of Aalto, which both use an artificial intelligence model based on LSTMs. This model allows a good reproduction of a distortion effect.    
